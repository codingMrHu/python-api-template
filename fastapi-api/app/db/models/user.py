...
from sqlalchemy import Column, DateTime, text, func, String
from sqlmodel import Field, select, SQLModel

from app.db.base import session_getter
from app.db.models.base import SQLModelSerializable, SQLModelSerializableTime, valid_password, valid_phone,\
...
class UserBase(SQLModelSerializable):
    ...
    last_login_time: Optional[datetime] = Field(sa_column=Column(DateTime,
                                                                      nullable=False,
